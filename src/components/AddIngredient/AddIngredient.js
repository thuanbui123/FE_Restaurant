...
function AddIngredient() {
    ...
    const callAccountApi = async () => {
        try {
            const response = await request('get', `/suppliers/get-list`);
    ...
    const fieldsConfig = [
        { name: 'code', label: 'Mã nguyên liệu', placeholder: 'Nhập mã nguyên liệu', type: 'text', required: true },
        { name: 'name', label: 'Tên nguyên liệu', placeholder: 'Nhập tên nguyên liệu', type: 'text', required: true },
        ...
        { name: 'quantity', label: 'Số lượng', placeholder: 'Nhập số lượng', type: 'number', required: true },
    ...
    const handleSave = async () => {
        try {
            await request('post', `/ingredients/add`, formData);
            setIsOpen(false);
            CustomToastMessage.success('Thêm nguyên liệu thành công', () => {
